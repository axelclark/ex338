...
const ir = RegExp(`^T?${s.source}$`),
  ar = /^-?P(?:(?:(-?\d{1,20}(?:\.\d{1,20})?)Y)?(?:(-?\d{1,20}(?:\.\d{1,20})?)M)?(?:(-?\d{1,20}(?:\.\d{1,20})?)W)?(?:(-?\d{1,20}(?:\.\d{1,20})?)D)?(?:T(?:(-?\d{1,20}(?:\.\d{1,20})?)H)?(?:(-?\d{1,20}(?:\.\d{1,20})?)M)?(?:(-?\d{1,20})(?:[.,](-?\d{1,20}))?S)?)?)$/
function or(e) {
...
const dr = /^(Mon|Tue|Wed|Thu|Fri|Sat|Sun), (\d\d) (Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec) (\d{4}) (\d\d):(\d\d):(\d\d) GMT$/,
  mr = /^(Monday|Tuesday|Wednesday|Thursday|Friday|Saturday|Sunday), (\d\d)-(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)-(\d\d) (\d\d):(\d\d):(\d\d) GMT$/,
  fr = /^(Mon|Tue|Wed|Thu|Fri|Sat|Sun) (Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec) ( \d|\d\d) (\d\d):(\d\d):(\d\d) (\d{4})$/
function yr(e) {
  var [, e, t, r, n, s, i, a] = e
...
function Sn(e, t, r, n, s, i) {
  ...
  return (e && 0 !== Object.keys(e).length) || t
    ? ((t = t || o),
      ...
      a ? e : e.setZone(o))
    : W.invalid(new l("unparsable", `the input "${s}" can't be parsed as ` + n))
}
function Tn(e, t, r = !0) {
  return e.isValid
    ? b
...
class W {
  ...
  static fromMillis(e, t = {}) {
    if (h(e))
      return e < -864e13 || 864e13 < e
        ...
        : new W({ ts: e, zone: p(t.zone, k.defaultZone), loc: v.fromObject(t) })
    throw new o(
  ...
  resolvedLocaleOptions(e = {}) {
    var { locale: e, numberingSystem: t, calendar: r } = b
