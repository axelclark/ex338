defmodule Ex338.Commish.InSeasonDraftEmail do
  ...
  defp in_season_draft_email_data(league_id, num_picks) do
    %{
      ...
      last_picks: InSeasonDraftPick.Store.last_picks(league_id, num_picks),
      next_picks: InSeasonDraftPick.Store.next_picks(league_id, num_picks)
    }
  end
end
