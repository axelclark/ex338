...
6. **6. Waiver Wire:** Originally set by reverse draft order. A successful claim drops you to the bottom. All non-rostered teams are on waivers. <span class="highlight">Waiver claims are submitted via the Fantasy Team page. Select the team/player (player) you want to add and/or drop and hit submit. Owners can submit three types of waivers:  add a player and drop a player (drop only if add is successful), only drop a player, or only add a player. The league will be notified via email and the waiver will be listed as pending on the site.</span>

  There will be a 3-day waiting period where any other Owner may claim the added player by submitting a new waiver for that player. <span class="highlight">“Drop only” waivers have no waiting period and are processed immediately.  If no roster positions are available when submitting a waiver to add a player, an Owner may include a player to drop if the claim is successful or submit a “drop only” claim during the 3-day waiting period (the “drop only” claim cannot be reversed if the claim is unsuccessful).</span>

  <span class="highlight">At the end of the 3-day period, new claims for that player will no longer be accepted and the commish will process the claim.  The Owner with the highest waiver priority will have the player added to its roster by the commish. If no roster positions are available on the team, the claim is invalid and the Owner with the next highest waiver priority will get the player.  In the case of a “drop only” claim to create an open position, it cannot be submitted after the wait period ends even if the claim has not been processed by the commish.  Once submitted, a claim may not be cancelled by the claiming Owner.</span>
