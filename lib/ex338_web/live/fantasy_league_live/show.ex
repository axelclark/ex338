defmodule Ex338Web.FantasyLeagueLive.Show do
  ...
  defp calendar_download(assigns) do
    ~H"""
    <div class="border-b border-gray-200 bg-white px-4 py-5 sm:px-6 shadow-sm sm:rounded-lg">
      <div class="-ml-4 -mt-4 flex flex-wrap items-center justify-between sm:flex-nowrap">
        ...
        <div class="ml-4 mt-4 shrink-0">
          <.link
            ...
            class="w-full relative inline-flex items-center rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
          >
            Download
          </.link>
        </div>
